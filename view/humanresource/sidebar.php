                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard" href="index.php"><span class="mini-sub-pro">Home</span></a></li> <!--
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Product Payment" href="course-payment.php"><span class="mini-sub-pro">Courses Payment</span></a></li>
                            </ul>
                        </li> <!--
                        <li>
