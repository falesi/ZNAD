                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.php"><span class="mini-sub-pro">Home</span></a></li>
                                <!-- 
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                -->
                                <li><a title="Student Profile" href="student-profile.php"><span class="mini-sub-pro">Student Profile</span></a></li>
                                <li><a title="Edit Profile" href="edit-student.php"><span class="mini-sub-pro">Edit Profile</span></a></li>
                            </ul>  
                        </li>
                        <li>
